...
const imagesRouter = require('./api/resources/images/images.route')
const necessitiesRouter = require('./api/resources/parameterizations/necessities/necessities.route')
...
app.use('/necessities',necessitiesRouter)
